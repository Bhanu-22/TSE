...
export const DEFAULT_CONFIG: ConfigurationData = {
  ...
  "stylingConfig": {
    ...
    "embeddedContent": {
      ...
      "customCSS": {
        "variables": {
          "--ts-var-button--primary-background": "rgba(11, 61, 145, 1.0)",
          "--ts-var-button--primary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--primary--hover-background": "rgba(11, 61, 145, 0.8)",
          "--ts-var-button--primary--active-background": "rgba(11, 61, 145, 0.6)",
          "--ts-var-button--secondary-background": "rgba(79, 142, 247, 1.0)",
          "--ts-var-button--secondary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--secondary--hover-background": "rgba(79, 142, 247, 0.8)",
          "--ts-var-button--secondary--active-background": "rgba(79, 142, 247, 0.6)",
          "--ts-var-button--tertiary-background": "rgba(255, 122, 89, 1.0)",
          "--ts-var-button--tertiary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--tertiary--hover-background": "rgba(255, 122, 89, 0.8)",
          "--ts-var-button--tertiary--active-background": "rgba(255, 122, 89, 0.6)",
          "--ts-var-menu-background": "rgba(79, 142, 247, 1.0)",
          "--ts-var-menu--hover-background": "rgba(79, 142, 247, 0.8)",
          "--ts-var-root-background": "#F2F0EF"
        },
        "rules_UNSTABLE": {}
      }
    },
