...
export const DEFAULT_CONFIG: ConfigurationData = {
  "standardMenus": [
    ...
    },
    {
      ...
      "spotterModelId": "SMOKE_MODEL_GUID",
  ...
  "appConfig": {
    "thoughtspotUrl": "https://stage.thoughtspot.cloud",
    "applicationName": "Smoke Portal 2025-12-08 09:17:56",
  ...
  "stylingConfig": {
    ...
    "embeddedContent": {
      ...
      "customCSS": {
        "variables": {
          "--ts-var-button--primary-background": "rgba(15, 23, 42, 1.0)",
          "--ts-var-button--primary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--primary--hover-background": "rgba(15, 23, 42, 0.8)",
          "--ts-var-button--primary--active-background": "rgba(15, 23, 42, 0.6)",
          "--ts-var-button--secondary-background": "rgba(29, 78, 216, 1.0)",
          "--ts-var-button--secondary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--secondary--hover-background": "rgba(29, 78, 216, 0.8)",
          "--ts-var-button--secondary--active-background": "rgba(29, 78, 216, 0.6)",
          "--ts-var-button--tertiary-background": "rgba(34, 211, 238, 1.0)",
          "--ts-var-button--tertiary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--tertiary--hover-background": "rgba(34, 211, 238, 0.8)",
          "--ts-var-button--tertiary--active-background": "rgba(34, 211, 238, 0.6)",
          "--ts-var-menu--hover-background": "rgba(29, 78, 216, 0.8)",
          "--ts-var-root-background": "#FFFFFF",
          "--ts-var-menu-background": "#FFFFFF",
          "--ts-var-liveboard-layout-background": "rgba(29, 78, 216, 1.0)"
        },
        "rules_UNSTABLE": {}
      }
    },
