...
export const DEFAULT_CONFIG: ConfigurationData = {
  "standardMenus": [
    ...
    },
    {
      ...
      "spotterModelId": "dbec0964-0a59-4762-85bb-a5ee0fafc816",
  ...
  "customMenus": [
    {
      ...
      "contentSelection": {
        ...
        "specificContent": {
          "liveboards": [
            "27d27c7b-682a-43aa-872f-2497aa03015d"
          ],
          "answers": []
        }
      },
  ...
  "appConfig": {
    ...
    "orgIdentifier": "707510048",
    "applicationName": "FlowAnalytics",
    "logo": "https://media.brand.dev/f0bf53fc-af13-404f-aa4c-a84d9c807213.png",
    "earlyAccessFlags": "enable-modular-home\nenable-custom-styling",
    "favicon": "https://media.brand.dev/f0bf53fc-af13-404f-aa4c-a84d9c807213.png",
    "showFooter": false,
  ...
  "stylingConfig": {
    "application": {
      "topBar": {
        ...
        "logoUrl": "https://media.brand.dev/f0bf53fc-af13-404f-aa4c-a84d9c807213.png"
      },
      "sidebar": {
        "backgroundColor": "#04449c",
    ...
    "embeddedContent": {
      ...
      "customCSS": {
        "variables": {
          "--ts-var-button--primary-background": "rgba(4, 68, 156, 1.0)",
          "--ts-var-button--primary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--primary--hover-background": "rgba(4, 68, 156, 0.8)",
          "--ts-var-button--primary--active-background": "rgba(4, 68, 156, 0.6)",
          "--ts-var-button--secondary-background": "rgba(4, 68, 156, 1.0)",
          "--ts-var-button--secondary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--secondary--hover-background": "rgba(4, 68, 156, 0.8)",
          "--ts-var-button--secondary--active-background": "rgba(4, 68, 156, 0.6)",
          "--ts-var-button--tertiary-background": "rgba(4, 68, 156, 1.0)",
          "--ts-var-button--tertiary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--tertiary--hover-background": "rgba(4, 68, 156, 0.8)",
          "--ts-var-button--tertiary--active-background": "rgba(4, 68, 156, 0.6)",
          "--ts-var-menu--hover-background": "rgba(4, 68, 156, 0.8)",
          "--ts-var-root-background": "#FFFFFF",
          "--ts-var-menu-background": "#FFFFFF",
          "--ts-var-liveboard-layout-background": "rgba(4, 68, 156, 1.0)"
        },
        "rules_UNSTABLE": {}
      }
    },
