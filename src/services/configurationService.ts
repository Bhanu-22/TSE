...
export const DEFAULT_CONFIG: ConfigurationData = {
  ...
  "stylingConfig": {
    ...
    "embeddedContent": {
      ...
      "customCSS": {
        "variables": {
          "--ts-var-button--primary-background": "rgba(255, 192, 203, 1.0)",
          "--ts-var-button--primary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--primary--hover-background": "rgba(255, 192, 203, 0.8)",
          "--ts-var-button--primary--active-background": "rgba(255, 192, 203, 0.6)",
