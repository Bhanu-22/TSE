...
export const DEFAULT_CONFIG: ConfigurationData = {
  "standardMenus": [
    ...
    },
    {
      ...
      "spotterModelId": "a07cb375-c0c2-49ad-8e2e-e8c1bea269ab",
  ...
  "customMenus": [
    {
      ...
      "contentSelection": {
        ...
        "specificContent": {
          "liveboards": [
            "6e918f5a-e775-4920-90bf-5fdcc3e04d3a"
          ],
          "answers": []
        }
      },
  ...
  "appConfig": {
    ...
    "orgIdentifier": "1381961861",
    "applicationName": "NASA",
    "logo": "https://media.brand.dev/4f6881e9-4970-40cb-a13b-d3823373ae6b.png",
    "earlyAccessFlags": "enable-modular-home\nenable-custom-styling",
    "favicon": "https://media.brand.dev/4f6881e9-4970-40cb-a13b-d3823373ae6b.png",
    "showFooter": false,
  ...
  "stylingConfig": {
    "application": {
      "topBar": {
        ...
        "logoUrl": "https://media.brand.dev/4f6881e9-4970-40cb-a13b-d3823373ae6b.png"
      },
      "sidebar": {
    ...
    "embeddedContent": {
      ...
      "customCSS": {
        "variables": {
          "--ts-var-button--primary-background": "rgba(13, 103, 176, 1.0)",
          "--ts-var-button--primary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--primary--hover-background": "rgba(13, 103, 176, 0.8)",
          "--ts-var-button--primary--active-background": "rgba(13, 103, 176, 0.6)",
          "--ts-var-button--secondary-background": "rgba(216, 170, 179, 1.0)",
          "--ts-var-button--secondary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--secondary--hover-background": "rgba(216, 170, 179, 0.8)",
          "--ts-var-button--secondary--active-background": "rgba(216, 170, 179, 0.6)",
          "--ts-var-button--tertiary-background": "rgba(140, 180, 200, 1.0)",
          "--ts-var-button--tertiary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--tertiary--hover-background": "rgba(140, 180, 200, 0.8)",
          "--ts-var-button--tertiary--active-background": "rgba(140, 180, 200, 0.6)",
          "--ts-var-menu--hover-background": "rgba(216, 170, 179, 0.8)",
          "--ts-var-root-background": "#FFFFFF",
          "--ts-var-menu-background": "#FFFFFF",
          "--ts-var-liveboard-layout-background": "rgba(216, 170, 179, 1.0)"
        },
        "rules_UNSTABLE": {}
      }
    },
