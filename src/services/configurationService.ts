...
export const DEFAULT_CONFIG: ConfigurationData = {
  "standardMenus": [
    ...
    },
    {
      ...
      "spotterModelId": "ad3c3cf7-1869-49b0-a868-976c4cb780a7",
  ...
  "customMenus": [
    {
      ...
      "contentSelection": {
        ...
        "specificContent": {
          "liveboards": [
            "81f38349-e474-4b36-affa-073274c77187"
          ],
          "answers": []
        }
      },
  ...
  "appConfig": {
    ...
    "orgIdentifier": "1569343107",
    "applicationName": "Amrutha Labs",
    "logo": "https://assets.7dxperts.com/static/default-logo.png",
    "earlyAccessFlags": "enable-modular-home\nenable-custom-styling",
    "favicon": "https://assets.7dxperts.com/static/default-logo.png",
    "showFooter": false,
  ...
  "stylingConfig": {
    "application": {
      "topBar": {
        ...
        "logoUrl": "https://assets.7dxperts.com/static/default-logo.png"
      },
      "sidebar": {
    ...
    "embeddedContent": {
      ...
      "customCSS": {
        "variables": {
          "--ts-var-button--primary-background": "rgba(68, 132, 244, 1.0)",
          "--ts-var-button--primary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--primary--hover-background": "rgba(68, 132, 244, 0.8)",
          "--ts-var-button--primary--active-background": "rgba(68, 132, 244, 0.6)",
          "--ts-var-button--secondary-background": "rgba(156, 196, 244, 1.0)",
          "--ts-var-button--secondary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--secondary--hover-background": "rgba(156, 196, 244, 0.8)",
          "--ts-var-button--secondary--active-background": "rgba(156, 196, 244, 0.6)",
          "--ts-var-button--tertiary-background": "rgba(4, 4, 4, 1.0)",
          "--ts-var-button--tertiary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--tertiary--hover-background": "rgba(4, 4, 4, 0.8)",
          "--ts-var-button--tertiary--active-background": "rgba(4, 4, 4, 0.6)",
          "--ts-var-menu--hover-background": "rgba(156, 196, 244, 0.8)",
          "--ts-var-root-background": "#FFFFFF",
          "--ts-var-menu-background": "#FFFFFF",
          "--ts-var-liveboard-layout-background": "rgba(156, 196, 244, 1.0)"
        },
        "rules_UNSTABLE": {}
      }
    },
