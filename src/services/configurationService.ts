...
export const DEFAULT_CONFIG: ConfigurationData = {
  "standardMenus": [
    ...
    },
    {
      ...
      "spotterModelId": "55ca6955-1f81-49ae-8066-9ab2880dc9b1",
  ...
  "customMenus": [
    {
      ...
      "contentSelection": {
        ...
        "specificContent": {
          "liveboards": [
            "5b3381dd-fe34-4e09-b9fe-23dd41afbcfb"
          ],
          "answers": []
        }
      },
  ...
  "appConfig": {
    ...
    "orgIdentifier": "1830864300",
    "applicationName": "InnovaWorks",
    "logo": "",
  ...
  "stylingConfig": {
    ...
    "embeddedContent": {
      ...
      "customCSS": {
        "variables": {
          "--ts-var-button--primary-background": "rgba(30, 100, 146, 1.0)",
          "--ts-var-button--primary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--primary--hover-background": "rgba(30, 100, 146, 0.8)",
          "--ts-var-button--primary--active-background": "rgba(30, 100, 146, 0.6)",
          "--ts-var-button--secondary-background": "rgba(12, 100, 146, 1.0)",
          "--ts-var-button--secondary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--secondary--hover-background": "rgba(12, 100, 146, 0.8)",
          "--ts-var-button--secondary--active-background": "rgba(12, 100, 146, 0.6)",
          "--ts-var-button--tertiary-background": "rgba(30, 100, 146, 1.0)",
          "--ts-var-button--tertiary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--tertiary--hover-background": "rgba(30, 100, 146, 0.8)",
          "--ts-var-button--tertiary--active-background": "rgba(30, 100, 146, 0.6)",
          "--ts-var-menu--hover-background": "rgba(12, 100, 146, 0.8)",
          "--ts-var-root-background": "#FFFFFF",
          "--ts-var-menu-background": "#FFFFFF",
          "--ts-var-liveboard-layout-background": "rgba(12, 100, 146, 1.0)"
        },
        "rules_UNSTABLE": {}
      }
    },
