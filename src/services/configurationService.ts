...
export const DEFAULT_CONFIG: ConfigurationData = {
  "standardMenus": [
    ...
    },
    {
      ...
      "spotterModelId": "9277b8ef-900a-44b7-af77-edd6c2f662ae",
  ...
  "customMenus": [
    {
      ...
      "contentSelection": {
        ...
        "specificContent": {
          "liveboards": [
            "10657d04-34cc-40c8-8cbb-5179e1413cd9"
          ],
          "answers": []
        }
      },
  ...
  "appConfig": {
    ...
    "applicationName": "7Dxperts",
    "logo": "https://media.brand.dev/76aff815-7491-40f7-8b48-0605eddf8079.png",
    "earlyAccessFlags": "enable-modular-home\nenable-custom-styling",
    "favicon": "https://media.brand.dev/76aff815-7491-40f7-8b48-0605eddf8079.png",
    "showFooter": false,
  ...
  "stylingConfig": {
    "application": {
      "topBar": {
        ...
        "logoUrl": "https://media.brand.dev/76aff815-7491-40f7-8b48-0605eddf8079.png"
      },
      "sidebar": {
        "backgroundColor": "#ffffff",
    ...
    "embeddedContent": {
      ...
      "customCSS": {
        "variables": {
          "--ts-var-button--primary-background": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--primary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--primary--hover-background": "rgba(255, 255, 255, 0.8)",
          "--ts-var-button--primary--active-background": "rgba(255, 255, 255, 0.6)",
          "--ts-var-button--secondary-background": "rgba(60, 186, 95, 1.0)",
          "--ts-var-button--secondary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--secondary--hover-background": "rgba(60, 186, 95, 0.8)",
          "--ts-var-button--secondary--active-background": "rgba(60, 186, 95, 0.6)",
          "--ts-var-button--tertiary-background": "rgba(29, 44, 52, 1.0)",
          "--ts-var-button--tertiary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--tertiary--hover-background": "rgba(29, 44, 52, 0.8)",
          "--ts-var-button--tertiary--active-background": "rgba(29, 44, 52, 0.6)",
          "--ts-var-menu--hover-background": "rgba(60, 186, 95, 0.8)",
          "--ts-var-root-background": "#FFFFFF",
          "--ts-var-menu-background": "#FFFFFF",
          "--ts-var-liveboard-layout-background": "rgba(60, 186, 95, 1.0)"
        },
        "rules_UNSTABLE": {}
      }
    },
