...
export const DEFAULT_CONFIG: ConfigurationData = {
  "standardMenus": [
    ...
    },
    {
      ...
      "spotterModelId": "34321dee-92c4-44f5-82ab-975e0453b4f3",
  ...
  "customMenus": [
    {
      ...
      "contentSelection": {
        ...
        "specificContent": {
          "liveboards": [
            "207048dd-a59c-43c1-b54b-39f520db7f89"
          ],
          "answers": []
        }
      },
  ...
  "appConfig": {
    ...
    "applicationName": "TriveniTech",
    "logo": "https://media.brand.dev/266de454-8642-4807-be62-7e6eafaf7510.png",
    "earlyAccessFlags": "enable-modular-home\nenable-custom-styling",
    "favicon": "https://media.brand.dev/266de454-8642-4807-be62-7e6eafaf7510.png",
    "showFooter": false,
  ...
  "stylingConfig": {
    "application": {
      "topBar": {
        ...
        "logoUrl": "https://media.brand.dev/266de454-8642-4807-be62-7e6eafaf7510.png"
      },
      "sidebar": {
    ...
    "embeddedContent": {
      ...
      "customCSS": {
        "variables": {
          "--ts-var-button--primary-background": "rgba(26, 102, 224, 1.0)",
          "--ts-var-button--primary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--primary--hover-background": "rgba(26, 102, 224, 0.8)",
          "--ts-var-button--primary--active-background": "rgba(26, 102, 224, 0.6)",
          "--ts-var-button--secondary-background": "rgba(127, 181, 232, 1.0)",
          "--ts-var-button--secondary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--secondary--hover-background": "rgba(127, 181, 232, 0.8)",
          "--ts-var-button--secondary--active-background": "rgba(127, 181, 232, 0.6)",
          "--ts-var-button--tertiary-background": "rgba(26, 102, 224, 1.0)",
          "--ts-var-button--tertiary-color": "rgba(255, 255, 255, 1.0)",
          "--ts-var-button--tertiary--hover-background": "rgba(26, 102, 224, 0.8)",
          "--ts-var-button--tertiary--active-background": "rgba(26, 102, 224, 0.6)",
          "--ts-var-menu--hover-background": "rgba(127, 181, 232, 0.8)",
          "--ts-var-root-background": "#FFFFFF",
          "--ts-var-menu-background": "#FFFFFF",
          "--ts-var-liveboard-layout-background": "rgba(127, 181, 232, 1.0)"
        },
        "rules_UNSTABLE": {}
      }
    },
